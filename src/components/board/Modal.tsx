...
const Modal = ({ selectedData, handleCancel, handleEditSubmit: function name(params:any) {
  ...
  const onEditChange = (e:React.FormEvent<HTMLFormElement>):void => {
    setEdited({ //문법
      ...edited,
  ...
  const onSubmitEdit = (e:React.FormEvent<HTMLFormElement>):void => {
    e.preventDefault();
